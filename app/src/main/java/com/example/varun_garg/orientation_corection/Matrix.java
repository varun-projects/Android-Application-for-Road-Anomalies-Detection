...
public class Matrix {
    ...
    public void setDataErrorCovariance(double... args) {
        assert(args.length == rows * cols);
        for (int r = 0; r < rows; ++r) {
            for (int c = 0; c < cols; ++c) {
                data[r][c] = args[r*cols + c];
                Log.d("tag_matrix", String.valueOf(data[r][c]));
    ...
    public void setDataDiag(double... args) {
        assert(args.length == rows * cols);
        for (int r = 0; r < rows; ++r) {
            for (int c = 0; c < cols; ++c) {
                data[r][c] = 0.0;
            ...
            //data[r][r] = args[r*cols -1];
             data[r][r] = args[r];
            Log.d("tag_matrix", String.valueOf(data[r][r]));
